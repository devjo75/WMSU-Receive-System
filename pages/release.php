            ...
            <div class="px-4 sm:px-6 lg:px-8 py-4">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3 min-w-0">
                        ...
                        <div class="min-w-0">
                            <h2 class="text-xl sm:text-2xl font-bold text-gray-800 font-main truncate">Release Monitoring</h2>
                            <p class="hidden sm:block text-sm text-gray-600 mt-1 font-secondary">Track acknowledgement status per released document</p>
                        </div>
                    </div>
                ...
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
                    ...
                    <div class="flex items-center gap-2 w-full sm:w-auto">
                        <input type="text" placeholder="Search document..."
                            class="flex-1 sm:w-60 px-4 py-2 border-2 border-gray-200 rounded-lg text-sm focus:outline-none focus:border-crimson-700 focus:ring-2 focus:ring-crimson-200 transition duration-200 font-secondary">
                        <button class="flex-shrink-0 p-2.5 rounded-lg border-2 border-gray-200 hover:border-crimson-300 hover:bg-crimson-50 transition duration-200">
